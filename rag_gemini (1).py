...
Original file is located at
    https://colab.research.google.com/drive/1H4uMYN6ij7-ntQpriQFxO8NvIJBeuQ4e
"""
...
pdf_text = load_pdf(file_path="1594399406-world-war-i-1.pdf")
...
db=load_chroma_collection(path="contents",name="rag_experiment") #replace with the collection name

answer = Response(db,query="when did Wilhelm II took throne?")
print(answer)
